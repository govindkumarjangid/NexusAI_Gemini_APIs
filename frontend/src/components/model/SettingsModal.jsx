            ...
            <Modal open={open} onClose={onClose}>
                ...
                <div className="flex flex-col sm:flex-row sm:h-120">
                    ...
                    <div className="flex-1 p-5 sm:p-6 overflow-y-auto">
                        ...
                        {tab === "account" && <AccountSettings onOpenDeleteConfirm={handleShowDeleteConfirm} />}
                    </div>

                </div>
            </Modal>

            {/* Delete Confirmation Modal - rendered separately to avoid stacking issues */}
            <DeleteConfirmDialog open={showDeleteModal} onClose={handleCloseDeleteConfirm} />
        </>
    );
}