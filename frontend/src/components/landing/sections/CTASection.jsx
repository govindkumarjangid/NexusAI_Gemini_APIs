    ...
    <Reveal>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <Link
            to="/register"
            className="inline-flex items-center gap-2 px-7 py-3 rounded-xl font-bold text-sm sm:text-base transition-all duration-300 hover:-translate-y-0.5 active:scale-95 group bg-(--accent-color) text-(--accent-text-color)"
          >
