                    ...
                    <>
                        ...
                        <motion.div
                            ...
                            className={`${isMobile
                                ...
                                : "absolute top-16 right-4 w-40 p-2 rounded-xl border shadow-lg"
                        ...
                        >
                            ...
                            <button
                                onClick={handlePin}
                                className={`flex items-center gap-3 rounded-xl cursor-pointer hover:bg-(--bg-hover) transition-all duration-300 active:scale-95 hover:text-(--text-primary) w-full font-medium mt-4 ${isMobile ? 'px-2.5 py-2 text-xs' : 'px-3 py-2.5 text-sm'}`} >
                            ...
                            <button
                                ...
                                className={`flex items-center gap-3 rounded-xl cursor-pointer hover:bg-red-500/10 text-red-500 transition-all duration-300 active:scale-95 w-full font-medium mb-4 ${isMobile ? 'px-2.5 py-2 text-xs' : 'px-3 py-2.5 text-sm'}`} >
