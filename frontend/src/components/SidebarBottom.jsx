...
const SidebarBottom = ({ sidebarOpen, handleLogout }) => (
  <div className="p-3 border-t border-gray-800/60 space-y-1 shrink-0">
    ...
    <button className="w-full flex items-center rounded-full hover:bg-gray-800 cursor-pointer transition-colors text-sm text-gray-300 h-11 overflow-hidden" title={!sidebarOpen ? "Preferences" : ""}>
      <div className="w-11 shrink-0 flex items-center justify-center">
        <Settings size={20} />
      </div>
